...
const longPath = 'http://127.0.0.1:3000/';

export const LOGIN = longPath + 'admin/login';
export const HOME = longPath + 'admin/home';
export const USER = longPath + 'admin/user';
export const LOGOUT = longPath + 'user/logout';

export const CATEGORY = longPath + 'category';
export const GET_CATEGORIES = longPath + 'category';
